...
// export const ImgLoader = class {
//     static async loadImages(...filenames) {
//         return new Promise((resolve) => {
...
//                 const onLoad = () => {
//                     ImgLoader.cache[key] = img instanceof HTMLImageElement ?
//                         img : ImgLoader.cache['placeholder'];
...
//     }
// };
// ImgLoader.cache = Object.create(null);