    ...
    constructor(x = 0, y = 0) {
        ...
        this.mis.update = function(dt, data = null) {
            ...
            if (this.fired) {
                ...
                if (data['player'].collCheck(this, data['gameXPos'])) {
                    data['player'].setHp(25);
                    ExpMgr.get().addExp(data['player'].x - data['gameXPos'] + (this.x - data['player'].x),
    ...
    collCheck(rect, xOffset = 0) {
        if (this.hp > 0) {
            ...
            if (this.mis.fired && result) {
                ...
                ExpMgr.get().addExp(rect.x - xOffset + (this.mis.x - rect.x),
        ...
        this.hp -= amt;
         if (this.hp <= 0) {
             ...
             this.blinkTimer.callback = function() {
                 ExpMgr.get().addExp(randInt(this.left + 50, this.right - 50) - data['gameXPos'], randInt(this.top + 100, this.bot));
             }.bind(this);
